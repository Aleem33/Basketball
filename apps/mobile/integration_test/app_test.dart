...
void main() {
  ...
  testWidgets('application renders public empty states and navigates between primary destinations', (WidgetTester tester) async {
    appRouter.go('/');
    await tester.pumpWidget(ProviderScope(
      overrides: [
        tournamentsProvider.overrideWith((Ref ref) async => const CachedResult<List<TournamentSummary>>(<TournamentSummary>[], isStale: false)),
        gamesProvider.overrideWith((Ref ref) async => const CachedResult<List<GameSummary>>(<GameSummary>[], isStale: false)),
      ],
